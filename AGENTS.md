# AI Agent Reference for ha-penny
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/penny/__init__.py` |
| Coordinator | `custom_components/penny/coordinator.py` |
| Config Flow | `custom_components/penny/config_flow.py` |
| Sensor platform | `custom_components/penny/sensor.py` |
| Binary Sensor | `custom_components/penny/binary_sensor.py` |
| Button platform | `custom_components/penny/button.py` |
| API Client | `custom_components/penny/api.py` |
